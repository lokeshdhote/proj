...
//         .json({ Success: true, token,data,role:role,message:"User logged in successfull" });
//     } catch (error) {
//       console.error("Error in sendtoken function:", error.message);  // Log the error for debugging
...
//       res.status(500).json({
//         Success: false,
//         message: "An error occurred while generating or setting the token. Please try again.",
//         error: error.message,  // Optionally provide the error message
//       });
//     }
//   };
